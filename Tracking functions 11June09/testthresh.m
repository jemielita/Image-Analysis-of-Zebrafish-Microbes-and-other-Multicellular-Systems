...
% last modified: June 2, 2007 -- use Grier et al. bandpass filter.
...
hupdate    = uicontrol('Style','checkbox',...
    ...
    'Position',[460,765,65,buttonheight],'value', 0, ...
    'Callback',{@update_Callback});
hjet    = uicontrol('Style','checkbox',...
    'String','Jet','FontWeight', 'bold',...
    'Position',[535,765,40,buttonheight],'value', 0, ...
...
hobjsizetext  = uicontrol('Style','edit',...
    'String','objsize', 'Position',[675,755,40,15], ...
    'Callback',{@objsizetext_Callback});
hobjsize = uicontrol('Style','slider', ...
    'Max', 50, 'Min', 2, 'Value', 2, ...
    'SliderStep', [0.02 0.1], 'Position', [720,755,140,15], ...
...
% Callback functions
    ...
    function update_Callback(source,eventdata)
        ...
        while showlive==1
            ...
            subplot(1,2,2); imagesc(threshA); colormap(cmap);
