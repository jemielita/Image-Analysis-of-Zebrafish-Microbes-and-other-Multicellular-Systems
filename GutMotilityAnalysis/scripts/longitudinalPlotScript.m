...
% plot(WTx5,WTAmplitude5, 'Linewidth', figureLineWidths, 'Color', lightBlueColor, 'Linestyle', '-.');
...
% plot(WTx1,WTAmplitude1, 'Linewidth', figureLineWidths+0.5, 'Color', lightBlueColor, 'Linestyle', ':');
