...
%
% Variables: -directory: String of the directory of the images
%            -settings: Cell array, of a cell array containing
%            strings/numbers/etc. The settings are:
%               -settings{1}- filetype, string
%               -settings{2}- Step size/window size of template

function PIVCallFunction(directory,settings)
...
s{1,1}= 'Int. area 1';           s{1,2}=2*settings{2};         % window size of first pass
s{2,1}= 'Step size 1';           s{2,2}=settings{2};         % step of first pass
...
s{7,1}= 'Int. area 2';           s{7,2}=2*settings{2};         % second pass window size
s{8,1}= 'Int. area 3';           s{8,2}=settings{2};         % third pass window size
s{9,1}= 'Int. area 4';           s{9,2}=settings{2};         % fourth pass window size
